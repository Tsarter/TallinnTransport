...
import time
from config import REALTIME_URL, REALTIME_DATA_DIR, INTERRUPTIONS_URL, INTERRUPTIONS_DATA_DIR
...
def check_and_save_interruptions():
    ...
    last_is_empty = len(last_data) == 0 if last_data is not None else True  # Check if last interruption data was empty
